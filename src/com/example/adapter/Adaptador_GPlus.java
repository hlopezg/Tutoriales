...
public class Adaptador_GPlus extends GPlusListAdapter{
	...
	public View getRowView(int position, View convertView, ViewGroup parent) {
		...
		if (listaDatos.get(position).id != 0) {
			...
			holder.Textview_fecha.setText("Agregado el: " + listaDatos.get(position).fecha);
	...
	public static class ViewHolder {
		private TextView TextView_nombre, Textview_descripcion, Textview_fecha, textView_subtitulo;
