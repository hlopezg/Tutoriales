...
public class Drawer_adapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		else if (listaDatos.get(position).disponibilidad == 5) {// pdf descargado
			holder.image1.setImageResource(R.drawable.youtube_icon);
		}
		else if (listaDatos.get(position).disponibilidad == 6) {// pdf descargado
			holder.image1.setImageResource(R.drawable.todos);
		}
		else if (listaDatos.get(position).disponibilidad == 7) {// pdf descargado
