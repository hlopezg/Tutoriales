...
public class Datos_Spinner {
	...
	public Datos_Spinner(int id, String nombre,String sub_titulo,String autor,String fecha, int leido,int disponiblidad,String idioma, String url,int favorito)
	{
		this.id = id;
		this.nombre = nombre;
