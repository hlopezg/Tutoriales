...
import com.example.ejemplo.fragments.tutorial_1;
import com.example.tutorial.fragments.Fragment_Introduccion;
...
public class TabActivity extends SherlockFragmentActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tab1.setText("Explicación");
		tab1.setTabListener(new MyTabListener());
		bar.addTab(tab1);

		if (id == 5) {
			tab2.setText("Ejemplo");
