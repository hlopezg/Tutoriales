...
import com.example.tutorial.fragments.Fragment_Introduccion_codigo;
import com.example.tutorial.fragments.Fragment_TabsActivity;
...
public class TabsActivityViewPager extends SherlockFragmentActivity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mTabsAdapter.addTab(bar.newTab().setText("Explicación"),Fragment_TabsActivity.class, null);
		mTabsAdapter.addTab(bar.newTab().setText("Código"),Fragment_Introduccion_codigo.class, null);
