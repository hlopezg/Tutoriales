...
public class pdfActivity extends SherlockActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			textView_autor_pdf.setText("Autor: " + getIntent().getExtras().getString("autor_Tutorial"));
			File file = new File(directorio, url.substring(url.lastIndexOf("/")));
			if (file.exists()) {
		...
		class DownloadAsyncTask extends AsyncTask<String, Float, String> {
			...
			ProgressDialog dialog = new ProgressDialog(pdfActivity.this);
			 ...
			 protected void onPreExecute() {
			        this.dialog.setMessage("Descargando archivo");
			...
			protected void onPostExecute(String result) {
				 ...
				 * AlertDialog.Builder(WebViewDemoActivity.this);
				 * builder.setMessage(result).setPositiveButton((R.string.ok),
				 * null).setTitle(getString(R.string.download)); builder.show();
				 */
				/*
				 * final Intent intent = new Intent(WebViewDemoActivity.this,
				 * pdf.class); intent.putExtra(PdfViewerActivity.EXTRA_PDFFILENAME,
				 * file.toString()); startActivity(intent);
				 */
				if (dialog.isShowing()) {
		            dialog.dismiss();
		        }
		...
		private void abrir_pdf(File file)
		{
			...
			}catch(ActivityNotFoundException ex)
			{
				...
				dialog.setTitle("Necesita un lector de PDF para ver este archivo");
		...
		public boolean onOptionsItemSelected(MenuItem item) {
			...
			case 2:
				...
				startActivity(Intent.createChooser(sharingIntent,
								"Seleccione su gestor de correo favorito para enviar un correo."));
				return true;
			case 3:
